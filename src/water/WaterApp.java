// ref: https://www.codejava.net/java-se/swing/java-swing-hello-world-tutorial-for-beginners-using-text-editor
// ref: https://javatutorial.net/java-swing-jframe-layouts
package water;
...
public class WaterApp extends JFrame implements ActionListener {
    ...
    public float giveMeWaterAmount(float weight) {
    	return this.calculateWaterAmount(weight);
    }
